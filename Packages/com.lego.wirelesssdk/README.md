...
<root>
  ...
  ├── Editor
  │   ├── LEGO.WirelessSDK.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── LEGO.WirelessSDK.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── LEGO.WirelessSDK.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── LEGO.WirelessSDK.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `LEGO.WirelessSDK`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package LEGO Wireless SDK Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/LEGO.WirelessSDK.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/LEGO.WirelessSDK.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/LEGO.WirelessSDK.Editor.Tests.asmdef`

  `Tests/Runtime/LEGO.WirelessSDK.Tests.asmdef`
...
Use the `Documentations~/LEGO Wireless SDK.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
